    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
                {/* Current Plan Card */}
                <Card className="flex flex-col relative overflow-hidden border-primary/20 shadow-lg shadow-primary/5">
                    {isPro && (
                        <div className="absolute top-0 right-0 bg-primary/10 text-primary px-4 py-1.5 rounded-bl-xl font-bold text-xs uppercase tracking-widest flex items-center gap-1.5 border-l border-b border-primary/20">
                    ...
                    <CardHeader>
                        <CardTitle className="flex items-center gap-3 text-2xl">
                            ...
                            {isPro && <Badge className="bg-primary hover:bg-primary/90">PRO</Badge>}
                        </CardTitle>
                    ...
                    <CardContent className="flex-1 space-y-6">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-lg ${isPro ? 'bg-green-500/10 text-green-500' : 'bg-muted text-muted-foreground'}`}>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={feature} className="p-3 rounded-lg bg-slate-900 border border-slate-800 text-sm font-medium text-slate-300 flex items-center gap-2">
