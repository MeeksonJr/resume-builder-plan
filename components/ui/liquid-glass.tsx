...
export const Component = () => {
  ...
  return (
    <div
      className="min-h-[500px] h-full flex items-center justify-center font-light relative overflow-hidden w-full rounded-3xl"
      style={{
    ...
    >
      ...
      <div className="flex flex-col gap-6 items-center justify-center w-full p-8">
        <GlassDock icons={dockIcons} href="/dashboard/scholarships" />

        <GlassButton href="/dashboard/scholarships">
          <div className="text-xl text-white">
            <p>Find scholarships made for you →</p>
          </div>
        </GlassButton>
      </div>     
    </div>
